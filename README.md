...
###### 3- Después de hacer la primera etapa, con ayuda de un generador de señales introducimos la señal y nos aseguramos que SW1 atenua la señal Y que Sw2 genera un desfase.
Esto lo visualizaríamos en el ociloscopio.
...
###### 6- Por último en el canal construiríamos la etapa de salida la cual hbria que comprobar el NE554 y el fadder del volumen junto con el potencimétro lineal. Y ver como le damos o le quitamos prioridad el canal derecho o al izquierdo.
...
<img src="https://github.com/Mesa-de-mezclas/Mesa-de-mezclas/blob/main/Im%C3%A1genes/Chasis%20entradas.jpeg?raw=true" width="50%"/>
